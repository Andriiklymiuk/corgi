...
// RenderRepoComposeEnvOverride builds the overlay that feeds corgi's env copy
// into every container of a repo compose file (env_file adds to, never
// replaces, what the repo's compose already sets).
