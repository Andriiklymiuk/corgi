...
* [corgi agent stream disable](corgi_agent_stream_disable)	 - Stop the phone reading sessions in a workspace (--workspace), or everywhere
* [corgi agent stream enable](corgi_agent_stream_enable)	 - Let the phone read sessions in a workspace (--workspace), or all (--all)
