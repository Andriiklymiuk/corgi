...
Show a workspace's session timeline (starts, exits, why)

```
corgi agent logs <workspace> [flags]
```
...
```
  -h, --help        help for logs
      --limit int   How many events to show, newest first (0 = all kept) (default 30)
```
