# corgi agent bot open

## corgi agent bot open

Open a bot in the editor window in front (the '+' key, as that bot)

```
corgi agent bot open <name> [flags]
```
...
```
  -h, --help            help for open
      --window string   The editor window to open it in (default: the one in front)
```
