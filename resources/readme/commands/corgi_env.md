...
```
      --explain string   Show every source that set this variable, in order, with the winner marked
...
* [corgi env check](corgi_env_check)	 - Fail when a service's env file misses keys its .env-example declares
