...
Start or stop a supervised session in a workspace, on demand
...
* [corgi agent session start](corgi_agent_session_start)	 - Ask the running daemon to start a session in a workspace
* [corgi agent session stop](corgi_agent_session_stop)	 - Ask the running daemon to stop a workspace's session
