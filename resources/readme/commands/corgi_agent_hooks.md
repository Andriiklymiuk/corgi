...
Get notified when a session in this workspace needs you
...
* [corgi agent hooks disable](corgi_agent_hooks_disable)	 - Remove the hooks corgi added to this workspace
* [corgi agent hooks enable](corgi_agent_hooks_enable)	 - Notify when a Claude session here asks for permission or finishes
