...
```
  ...
  -d, --detach                         Start every service as a detached process group that survives corgi
      ...
      --docker                         Run docker-capable services in containers instead of their start scripts.
      ...
      --dump-on-failure                When a --wait boot fails, print the tail of every service log. The
                                       reason is in the logs rather than in the error, and in CI they are otherwise
                                       only reachable after the job has ended. Pass --dump-on-failure=false to skip. (default true)
      ...
      --follow                         With --detach --wait: stream every service's log while waiting for the
  ...
  -h, --help                           help for run
      ...
      --logs                           Persist stdout/stderr of every service and db_service to
                                       ...
                                       Pass --logs=false to disable for a single run. (default true)
      ...
      --omit strings                   Compose keys to skip for this run, without editing corgi-compose.yml.
  ...
  -s, --seed                           Seed all db_services that have seedSource or have dump.sql / dump.bak or other dump file in their folder
      ...
      --wait-timeout duration          With --detach --wait: max time to wait for the whole stack to become healthy. (default 5m0s)
