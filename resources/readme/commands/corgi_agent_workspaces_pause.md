# corgi agent workspaces pause

## corgi agent workspaces pause

Stop supervising a workspace (autostart: false): no device at login, no restarts; it stays registered

```
corgi agent workspaces pause <id> [flags]
```
