...
Set up a stack from corgi-compose.yml (clone repos, create db services + env)

### Synopsis

Prepares everything corgi-compose.yml describes, without starting it: clones each
