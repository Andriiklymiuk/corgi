# corgi agent stream disable

## corgi agent stream disable

Stop the phone reading sessions in a workspace (--workspace), or everywhere

```
corgi agent stream disable [flags]
```
...
```
  -h, --help               help for disable
      --workspace string   Only this workspace (default: everywhere)
```
