...
Approve a Claude connector sign-in waiting on this machine

### Synopsis

When a Claude connector (or any MCP client) signs in to corgi from a browser
...
```
corgi agent approve <code> [flags]
```
