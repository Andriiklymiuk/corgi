# corgi agent stream enable

## corgi agent stream enable

Let the phone read sessions in a workspace (--workspace), or all (--all)

```
corgi agent stream enable [flags]
```
...
```
  ...
  -h, --help               help for enable
      --workspace string   The registered workspace (default: the one you are in)
```
