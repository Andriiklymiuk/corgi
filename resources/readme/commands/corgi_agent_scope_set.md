# corgi agent scope set

## corgi agent scope set

Write a ticket's scope

```
corgi agent scope set <ref> [flags]
```
...
```
      ...
      --done stringArray   what finished means, one line (repeatable)
  -h, --help               help for set
      --lines int          diff budget: added plus removed lines
      --path stringArray   a glob the change may touch, relative to the workspace (repeatable; ** crosses directories)
      --tests int          how many new test files at most
```
