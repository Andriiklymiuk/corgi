# corgi agent task edit

## corgi agent task edit

Change a task's title, description or workspace

```
corgi agent task edit <TASK-N> [flags]
```

### Options

```
      --body string        a new description
  -h, --help               help for edit
      --title string       a new title
      --workspace string   a new workspace
```
