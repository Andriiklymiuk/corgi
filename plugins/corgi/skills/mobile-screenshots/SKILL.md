...
- Guideline 2.1 demo-account rejection on a login-less app → stage a plain-language review `notes.txt` (no account, why it exists, value), then reply in Resolution Center with a screen recording by hand.
